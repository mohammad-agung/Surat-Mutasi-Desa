...
if (isset($_SESSION['login']) == 0) {
    ...
    $id = 1;
    $query = mysqli_query($conn, "SELECT tbl_arsip_pindah.nik_pemohon,tbl_arsip_pindah.nama_pemohon,tbl_arsip_pindah.tanggal_arsip,tbl_arsip_pindah.status,tbl_admin.nama_user FROM tbl_arsip_pindah INNER JOIN tbl_admin ON tbl_arsip_pindah.id_petugas = tbl_admin.id_user");
?>
    <!doctype html>
    <html lang="en">
