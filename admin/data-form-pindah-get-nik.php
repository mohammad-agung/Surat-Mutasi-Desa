...
$nik_id = $_GET['nik'];
$query = mysqli_query($conn, "SELECT * FROM tbl_datapindah WHERE nik_pemohon='$nik_id'");
?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly type="text" id="val-nomorkk" name="nomorkk" class="form-control" required value="<?= htmlentities($row['nomorkk_asal']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="val-nama_kepala_keluarga">Nama Kepala Keluarga</label>
                                <input readonly type="text" id="val-nama_kepala_keluarga" name="namakepalakeluarga" class="form-control" required value="<?= htmlentities($row['namakepalakeluarga_asal']); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input readonly type="text" id="val-alasanpindah" name="alasanpindah" class="form-control" required value="<?= htmlentities($row['alasan_pindah']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row mt-2">
                        <?php if ($row['status'] == 1) { ?>
                            <div class="col-12 col-md-2">
                                <button type="submit" name="arsipterimapindah" class="btn btn-primary full-button">Arsip Data</button>
                            </div>
                            <div class="col-12 col-md-2">
                                <button type="submit" name="arsiptundapindah" class="btn btn-danger full-button">Pending Data</button>
                            </div>
                        <?php } ?>
                    </div>
                    <!-- END Submit -->
