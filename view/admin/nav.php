    ...
    <div class="content-side content-side-full">
        <ul class="nav-main">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                    <i class="nav-main-link-icon si si-layers"></i>
                    <span class="nav-main-link-name">Data Surat Pindah</span>
                </a>
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                    <i class="nav-main-link-icon si si-layers"></i>
                    <span class="nav-main-link-name">Data Surat Datang</span>
                </a>
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="arsip-data-datang-ditunda">
                            <span class="nav-main-link-name">Data Ditunda</span>
                        </a>
                    </li>
                </ul>
